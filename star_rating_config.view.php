 ...
 */
class star_rating_configView extends star_rating_config
{
	/**
	 * Target mid
	...
	function IS()
	{
		...
		if($is_keyword)
		{
			$oIS = getModel('star_rating_config');
			switch($where)
			{
				case 'document' :
...
/* End of file star_rating_config.view.php */
/* Location: ./modules/star_rating_config/star_rating_config.view.php */
